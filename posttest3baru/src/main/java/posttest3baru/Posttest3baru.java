        ...
        switch (pil) {
            case 1 -> {
                ...
                for(int i = 0; i < listonline.size();i++){
                    ...
                    System.out.println("==================================================");
                    System.out.println("Data Index ke-" + (i+1));
                    System.out.println("Nama :" + listonline.get(i).getName());
                    System.out.println("Harga kamar :" + listonline.get(i).getHarga());
                    System.out.println("Nomer Kamar :" + listonline.get(i).getnomer());
                    System.out.println("kode Boking :" + listonline.get(i).getKodeboking());
                    System.out.println("Tanggal Dipesan :" + listonline.get(i).getTanggal());
                }
                System.out.println("==================================================");
            }
            case 2 -> {
                ...
                for(int i = 0; i < listofline.size();i++){
                    ...
                    System.out.println("==================================================");
                    System.out.println("Data Index ke-" + (i+1));
                    System.out.println("Nama :" + listofline.get(i).getName());
                    System.out.println("Harga Kamar :" + listofline.get(i).getHarga());
                    System.out.println("Nomer kamar :" + listofline.get(i).getnomer());
                    System.out.println("Nomer Ressi:" + listofline.get(i).getNomerresi());
                }
                System.out.println("==================================================");
            }
            default -> System.out.println("Pilihan salah");
